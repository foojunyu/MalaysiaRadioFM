...
public partial class MainWindow : Window
{
    ...
    private void InitializeRadioStations()
    {
        ...
        radioStations.Add(new RadioStation("BFM 89.9", "https://playerservices.streamtheworld.com/api/livestream-redirect/BFMAAC.aac", "The business station"));
        radioStations.Add(new RadioStation("Traxx FM", "https://astro3.rastream.com/traxx", "The sound of the nation"));
        // Note: AI FM uses HTTP as HTTPS is not available on their streaming service
